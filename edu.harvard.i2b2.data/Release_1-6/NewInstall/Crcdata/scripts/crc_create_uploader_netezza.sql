...
--==============================================================
CREATE SEQUENCE SQ_UPLOADSTATUS_UPLOADID START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 99999
    NO CYCLE;
...
CREATE SEQUENCE SQ_UP_ENCDIM_ENCOUNTERNUM START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 99999
    NO CYCLE;

CREATE SEQUENCE SQ_UP_PATDIM_PATIENTNUM START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    MAXVALUE 99999
    NO CYCLE;
